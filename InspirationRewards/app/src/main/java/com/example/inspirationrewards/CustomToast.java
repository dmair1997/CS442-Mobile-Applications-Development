...
public class CustomToast {
    ...
    public void showCustomToast(String message, int colorValue) {
        View v = activity.getLayoutInflater().inflate(R.layout.custom_toast, (ViewGroup) activity.findViewById(R.id.custom_toast));
        TextView textView = v.findViewById(R.id.custom_toast_text);
        CardView cardView = v.findViewById(R.id.cardview_toast);
