...
public class RewardsAPIAsyncTask extends AsyncTask<String, Void, String> {
    ...
    public RewardsAPIAsyncTask(AwardActivity awardActivity, AllProfiles alldata, int points, String comments) {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            target.put("studentId", "20375823");
            target.put("username", alldata.getUsername());
