...
public class UpdateProfileAPIAsyncTask extends AsyncTask<String,Void,String> {
    ...
    public UpdateProfileAPIAsyncTask(EditProfileActivity editProfileActivity, List<Rewards> rewardsContentList) {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            jsonObject.put("studentId", "20375823");
    ...
    private String doAPICall(JSONObject jsonObject) {
        ...
        try {
            ...
            String urlString = baseUrl + profilesEndPoint;
